...
function ItemList({ item, onToggle }: ItemListType): JSX.Element {
    //const [showDelete, setShowDelete] = useState(false);

    return (
        <div className="bg-bg-primary border-1 rounded-lg shadow-lg w-full min-h-16 max-h-[74px] mx-auto p-3">
